/*v0.6vv_20161117_nt*/
window.__wcc_version__ = 'v0.6vv_20161117_nt'
var $gwxc
var $gaic = {}
$gwx = function(path, global) {
		...
		function ArithmeticEv(ops, e, s, g, o) {
			...
			switch (rop) {
				case '?:':
					...
					_d = wh.rv(_a) ? rev(ops[2], s, e, g, o) : rev(ops[3], s, e, g, o);
				...
				case '&&':
					_a = rev(ops[1], e, s, g, o);
					_c = should_pass_type_info && (wh.hn(_a) === 'h');
					_d = wh.rv(_a) ? rev(ops[2], e, s, g, o) : false;
					_d = _c && wh.hn(_d) === 'n' ? wh.nh(_d, 'c') : _d;
					return _d;
					break;
				case '||':
	...
	function wfor(to_iter, func, env, scope, global, father, itemname, indexname, keyname) {
		...
		if (_n) {
			if (type === 'A') {
				for (var i = 0; i < to_iter.length; i++) {
					...
					scope[indexname] = i;
					_y = keyname ? (keyname === "*this" ? _v(wh.rv(to_iter[i])) : _v(wh.rv(to_iter[i])[keyname])) : _v();
					_(father, _y);
				...
				for (var k in to_iter) {
					...
					scope[indexname] = k;
					_y = keyname ? (keyname === "*this" ? _v(wh.rv(to_iter[k])) : _v(wh.rv(to_iter[k])[keyname])) : _v();
					_(father, _y);
					func(env, scope, _y, global);
				}
			} else if (type === 'S') {
			...
			if (type === 'A') {
				for (var i = 0; i < r_to_iter.length; i++) {
					...
					scope[indexname] = i;
					_y = keyname ? (keyname === "*this" ? _v(r_iter_item) : _v(r_iter_item[keyname])) : _v();
					_(father, _y);
					func(env, scope, _y, global);
				}
			} else if (type === 'O') {
